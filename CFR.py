...
class CFRMonitor():
    ...
    def gui(self):
        ...
        [sg.Text('信息有效期',size=(12, 1), font=("宋体", 13))],
        [sg.Button(button_text='开始监测',key='_start_',size=(12, 1),font=("宋体", 13)),sg.Button(button_text='写入配置文件',key='_config_',size=(12, 1),font=("宋体", 13))]
        ]
        window = sg.Window('CFR信息监测工具', default_element_size=(40, 3)).Layout(layout)
        while True:
            button,values = window.Read()
